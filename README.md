...
Include [the javascript](https://raw.github.com/HubSpot/offline/v0.4.1/offline.min.js) and one of [the themes](http://github.hubspot.com/offline/docs/welcome/) on your site.  You're done!
